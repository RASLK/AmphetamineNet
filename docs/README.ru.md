...
- Запуск / остановка сеанса «не спать» из трея, с выбором длительности: **Бессрочно**, 5 / 15 / 30 минут, 1 / 2 / 5 часов
...
- Небольшое окно настроек (открывается из меню трея) дублирует те же элементы управления на большей площади
- Состояние сеанса и статус крышки отображаются в реальном времени и в меню трея, и в окне настроек
